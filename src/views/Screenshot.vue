...
function createRect(layer: Konva.Layer, x: number, y: number, w = 0, h = 0, opacity = 0, draggable = false) {
  const width = w,
    height = h
...
<template>
  <div>
    <div class="sc-souce-container" :style="'z-index: 1;background-image:url(' + imageUrla + ')'"></div>
    <div
